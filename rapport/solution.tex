...
\begin{itemize}
  \item
    On met la valeur zéro pour toutes les prédictions: le score de 800.000 environ.
    Cela nous donne un ordre de grandeur sur les score: toute méthode donnant un score supérieur à 800.000 n'est vraiment pas adaptée.
  \item
    On met une valeur constante pour chaque polluant égale à la moyenne de toutes les valeurs pour ce polluant: on obtient une score de 350.000 environ.
    C'est nettement mieux que le benchmark de Plume Labs.
    Il est donc probable que leur solution overfitte les données d'entrainement.
  \item
